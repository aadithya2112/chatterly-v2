...
const PanelGroupPrimitive = ResizablePrimitive.Group
const PanelPrimitive = ResizablePrimitive.Panel
const PanelResizeHandlePrimitive = ResizablePrimitive.Separator
